...
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2019/04/01 17:12:12 by cecourt           #+#    #+#             */
/*   Updated: 2019/04/01 19:14:13 by cecourt          ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */

#include "fillit.h"

static int		check_square5(t_type *square, char tetri, int pos)
{
	if (tetri == 3
...
static int		check_square4(t_type *square, char tetri, int pos)
{
	if (tetri == 0
		&& (pos + 1) % square->size != 0
...
static int		check_square3(t_type *square, char tetri, int pos)
{
	if (tetri == -3
		&& (pos + 1) % square->size != 0
		&& pos + 2 * square->size < square->size * square->size
...
static int		check_square2(t_type *square, char tetri, int pos)
{
	if (tetri == -6
		&& (pos + 1) % square->size != 0
		&& pos + 2 * square->size + 1 < square->size * square->size
