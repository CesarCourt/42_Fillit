...
static void		full_square5(t_type *square, char tetri, char nbr, int pos)
{
	if (tetri == 3)
	{
		square->str[pos] = nbr;
...
static void		full_square4(t_type *square, char tetri, char nbr, int pos)
{
	if (tetri == 0)
	{
		square->str[pos] = nbr;
...
static void		full_square3(t_type *square, char tetri, char nbr, int pos)
{
	if (tetri == -3)
	{
		square->str[pos] = nbr;
...
static void		full_square2(t_type *square, char tetri, char nbr, int pos)
{
	if (tetri == -6)
	{
		square->str[pos] = nbr;
